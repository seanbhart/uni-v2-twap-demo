...
contract UniswapV2Factory is IUniswapV2Factory {
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        console.log("UniswapV2Factory-createPair-this", address(this), tokenA, tokenB);
        ...
        console.log("UniswapV2Factory-createPair-pair", pair);
        ...
        console.log("UniswapV2Factory-createPair-pair0-1", getPair[token0][token1]);
        console.log("UniswapV2Factory-createPair-pair1-0", getPair[token1][token0]);
        allPairs.push(pair);
        console.log("UniswapV2Factory-createPair-allPairs.length", allPairs.length);

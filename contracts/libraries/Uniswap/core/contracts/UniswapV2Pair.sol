...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    function _update(uint balance0, uint balance1, uint112 _reserve0, uint112 _reserve1) private {
        ...
        // console.log("UniswapV2Pair-_update-_reserve0", _reserve0);
        // console.log("UniswapV2Pair-_update-_reserve1", _reserve1);
        // console.log("UniswapV2Pair-_update-blockTimestamp", blockTimestamp);
        // console.log("UniswapV2Pair-_update-timeElapsed", timeElapsed);
        if (timeElapsed > 0 && _reserve0 != 0 && _reserve1 != 0) {
            // * never overflows, and + overflow is desired
            price0CumulativeLast += uint(UQ112x112.encode(_reserve1).uqdiv(_reserve0)) * timeElapsed;
            price1CumulativeLast += uint(UQ112x112.encode(_reserve0).uqdiv(_reserve1)) * timeElapsed;
        }
        // console.log("UniswapV2Pair-_update-uqRatio1/0", uint(UQ112x112.encode(_reserve1).uqdiv(_reserve0)));
        // console.log("UniswapV2Pair-_update-uqRatio0/1", uint(UQ112x112.encode(_reserve0).uqdiv(_reserve1)));
        // console.log("UniswapV2Pair-_update-price0CumulativeLast", price0CumulativeLast);
        // console.log("UniswapV2Pair-_update-price1CumulativeLast", price1CumulativeLast);
